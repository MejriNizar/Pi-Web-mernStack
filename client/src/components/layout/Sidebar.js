...
export default class Sidebar extends React.Component {
  ...
  componentDidMount() {
    axios
      .get("/api/project/activatedProject")
      .then((response) => {
  ...
  onChange(args) {
    this.sidebarObj.position =
      args.event.target.id === "left" ? "Left" : "Right";
  }
  generate(element) {
  ...
  render() {
    return (
      <div id="outer-container">
        ...
        >
          <div className="title">
            <i className="fas fa-code"></i>EDUPS
          </div>
          <div>
            <List>
             <Link to={"/"}> <ListItem>
